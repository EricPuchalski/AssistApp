...
const totalInscriptionPages = Math.ceil(inscriptions.length / inscriptionsPerPage); // Total de páginas
...
const currentInscriptions = inscriptions.slice(indexOfFirstInscription, indexOfLastInscription);
...
{activeTab === "inscripciones" && (
  <div className="bg-white p-6 rounded-lg shadow-md">
    <h2 className="text-2xl font-semibold mb-6 text-indigo-700">Inscripciones</h2>
    <form
    ...
    <div className="overflow-x-auto">
      <table className="w-full">
        ...
        <tbody>
          {currentInscriptions.map((inscription) => ( // Cambiado a currentInscriptions
            <tr
              key={inscription.id}
